...
def forward(image_number):
    ...
    status = Label(root, text="Image " + str(image_number) + " of " + str(len(image_list)), bd=1, relief=SUNKEN,
                   anchor=E, bg="#62a3a0", fg="#472669", font="helvatica 11 bold")
...
status = Label(root, text="Image 1 of " + str(len(image_list)), bd=1, relief=SUNKEN, anchor=E, bg="#62a3a0",
               fg="#472669", font="helvatica 11 bold")
status.grid(row=7, column=1, columnspan=5, sticky=W + E)
